...
(async () => {
  ...
  const testUrl =
    "http://mintlify-dev-server:3000/developers/en-us/activities/rich-presence/using-with-the-embedded-app-sdk";
  ...
  if (zhMonetizationLink.href !== expectedZhMonetization) {
    console.error(
      `❌ Mismatch on monetization page! Expected: ${expectedZhMonetization}, Got: ${zhMonetizationLink.href}`,
    );
    process.exit(1);
  }
