...
<LanguageSelector current="en" path="/developers/en-us/rich-presence/using-with-the-embedded-app-sdk" />
...
<Info>
Not sure if you should be building with the Embedded App SDK? Read through [Choosing an SDK](/developers/en-us/platform/rich-presence#choosing-an-sdk) to understand your options when integrating Rich Presence with your app.
</Info>
