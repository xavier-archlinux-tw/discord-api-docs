...
---
import AppCreationSteps from '/snippets/en-us/discord-social-sdk/partials/getting-started.mdx'
import ConsoleAccess from '/snippets/en-us/discord-social-sdk/callouts/console-access.mdx';
import SupportCallout from '/snippets/en-us/discord-social-sdk/callouts/support.mdx';
import DylibMacError from '/snippets/en-us/discord-social-sdk/partials/dylib-mac-error.mdx';
