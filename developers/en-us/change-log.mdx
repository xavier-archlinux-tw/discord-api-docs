...
<Update label="November 09, 2017" rss={{
  ...
  * Displaying "Spectate" and "Ask to Join" buttons on users' profiles
  ...
  For more information, check out our [Rich Presence site](https://discord.com/rich-presence). To get started on development, [read the docs](/developers/en-us/platform/rich-presence)!
</Update>
